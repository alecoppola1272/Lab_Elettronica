...
void diodoCal()
{
    ...
    Float_t ex[8] = {5.81, 10.74, 20.59, 30.89, 39.67, 49.52, 59.19, 79.13}; // Errori su tensione oscilloscopio
...
{
    gStyle->SetOptFit(111);
    TCanvas *c = new TCanvas("Germanio");
    c->SetGrid();
    c->SetLogy();
    ...
    TF1 *f = new TF1("f", "[0]*(exp(x/[1]-1))", 40, 400); // fit caratteristica I-V
    f->SetParName(0, "I0");
    f->SetParName(1, "EtaVt");
    f->SetParameter(0, 1e-2);
    f->SetParameter(1, 25);
